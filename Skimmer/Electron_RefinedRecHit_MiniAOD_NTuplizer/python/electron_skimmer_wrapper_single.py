...
#       'root://cms-xrd-global.cern.ch//store/mc/RunIISummer20UL18RECO/DoublePhoton_Pt-5To300-gun/AODSIM/FlatPU0to70EdalIdealGT_EdalIdealGT_106X_upgrade2018_realistic_v11_L1v1_EcalIdealIC-v2/130000/EFE5A23C-7B5C-CF48-B803-97E404663C12.root'
      'root://cms-xrd-global.cern.ch//store/mc/Run3Summer21MiniAOD/DoubleElectron_FlatPt-1To500/MINIAODSIM/FlatPU0to70IDEALGT_120X_mcRun3_2021_realistic_v5-v2/2530000/64ac9726-e32b-4195-80f4-b8adf6f3d7a7.root'
    ),
...
#        eleTightIdMap = cms.InputTag(""),
        ...
        eleMediumIdMap = cms.InputTag("egmGsfElectronIDs:cutBasedElectronID-RunIIIWinter22-V1-medium"),
        eleTightIdMap = cms.InputTag("egmGsfElectronIDs:cutBasedElectronID-RunIIIWinter22-V1-tight")
        )
...
process.TFileService = cms.Service("TFileService",
     #fileName = cms.string("hist.root"),
     #fileName = cms.string("ElectronRecHits_ntuple.root"),
     fileName = cms.string('64ac9726-e32b-4195-80f4-b8adf6f3d7a7.root'),
     closeFileFast = cms.untracked.bool(True)
  )
